...
const STRINGS = {
  ar: {
    ...
    signIn: 'تسجيل الدخول',
    signOut: 'خروج',
    heroTitle: 'منشآت في انتظار الحل',
    heroSub: 'الجهات المستهدفة التي تواجه تحديات عالية، وتنتظر حلول «أكثم» الاستباقية لتأمين استقرارها التنظيمي.',
  ...
  en: {
    ...
    signIn: 'Sign in',
    signOut: 'Sign out',
    heroTitle: 'Organizations awaiting a solution',
    heroSub: 'Targeted organizations facing high challenges, awaiting Aktham’s proactive solutions to secure their organizational stability.',
